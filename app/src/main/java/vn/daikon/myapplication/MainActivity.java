...
public class MainActivity extends AppCompatActivity implements MyInterface.View , AdapterView.OnItemSelectedListener {
    ...
    ImageButton im_sw,im_clear,bt_speech;
    TextView tv_out;
    EditText et_inp;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im_clear = (ImageButton) findViewById(R.id.clear_text);
        lv = (ListView) findViewById(R.id.list_item);
        bt_speech = (ImageButton) findViewById(R.id.speech_bt);
...
//        });
    ...
    void setAdapter(){
        ...
        translateAdapter = new TranslateAdapter(list);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.copy:
                checkCopy =! checkCopy;
                Toast.makeText(this,"Enable copy: " + checkCopy,Toast.LENGTH_LONG).show();
                item.setChecked(checkCopy);
                if (checkCopy) {
                    startService(new Intent(MainActivity.this, MyService.class));
                }
                else stopService(new Intent(MainActivity.this, MyService.class));
